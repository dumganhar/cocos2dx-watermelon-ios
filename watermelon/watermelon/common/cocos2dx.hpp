...
JSBool js_cocos2dx_CCTexture2D_setResolutionType(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_CCTexture2D_getResolutionType(JSContext *cx, uint32_t argc, jsval *vp);

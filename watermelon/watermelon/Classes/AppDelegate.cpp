...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    //sc->addRegisterCallback(register_chipmunk);
    sc->addRegisterCallback(register_ChipmunkSprite);
    sc->addRegisterCallback(registerCocosBuilder);
    ...
    ScriptingCore::getInstance()->runScript("js/game-main.js");
//
//    CCPoolManager::sharedPoolManager()->pop();
//        
//    ScriptingCore::dumpRoots();
//
//    sc->start();

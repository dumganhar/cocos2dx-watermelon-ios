...
public:
    ...
    int executeCCBuilderCallback(const char *id);
    int executeCCBuilderCallback(const char *id, jsval owner);
    
    int executeCCBuilderCallback(CCObject *self);

    void setCCBProxy(const char *propName, CCObject *obj);
    const char* getCCBProxy(CCObject *obj);
